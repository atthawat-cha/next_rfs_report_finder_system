              ...
              <Field>
                ...
                <RadioGroup defaultValue="crystal" className="flex space-x-2">
                  <Field orientation="horizontal">
                    <RadioGroupItem value="crystal" id="type-crystal" />
                    <FieldLabel htmlFor="type-crystal" className="font-normal">
                      Crystal
                    </FieldLabel>
                  </Field>
                  <Field orientation="horizontal">
                    <RadioGroupItem value="jasper" id="type-jasper" />
                    <FieldLabel htmlFor="type-jasper" className="font-normal">
                      Jasper
                    </FieldLabel>
                  </Field>
                </RadioGroup>
