...
5. **ของค้าง #13** — role `ADMIN` ธรรมดาดาวน์โหลด/พรีวิวไฟล์ไม่ได้เลย (403) เพราะ `routeAcceptted('user')` ไม่รวม `'admin'` — ไม่บล็อก 5d แต่ควรแก้ก่อนเปิดใช้งานจริงกับ role นี้
